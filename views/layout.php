		 	...
		 	<a class="navbar-brand" href="?controller=home">Home</a>
		  	...
		  	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		    	<ul class="navbar-nav mr-auto">
		      	...
		      	<li class="nav-item active">
		       		<a href="?controller=categories" class="nav-link">Categorías</a>
		      	</li>
		      	<li class="nav-item active">
		       		<a href="?controller=rol" class="nav-link">Roles</a>
		      	</li>
		      	<li class="nav-item active">
		       		<a href="?controller=rental" class="nav-link">Rentals</a>
		      	</li>				
		      	<li class="nav-item active">
		       		<a href="?controller=movie" class="nav-link">Movies</a>
		      	</li>      
		    </ul>
		  </div>
		</nav>			
